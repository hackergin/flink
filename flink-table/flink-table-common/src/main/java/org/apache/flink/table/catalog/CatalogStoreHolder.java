 ...
 * useful in SQL gateway scenarios where different sessions may use different catalogs. However, in
 * some scenarios, a single {@link CatalogStore} instance may be sufficient, in which case the
 * {@link CatalogStoreFactory} can be stored in the holder to ensure that it is properly closed when
 * the {@link CatalogStore} is closed.
 */
