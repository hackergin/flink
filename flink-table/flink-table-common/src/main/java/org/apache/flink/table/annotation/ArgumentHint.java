 ...
 *
 * <p>{@code @ArgumentHint(name = "in1", type = @DataTypeHint("STRING"), isOptional = false} an
 * argument with the type String, named in1, and it is a required parameter.
 */
@PublicEvolving
...
public @interface ArgumentHint {
     ...
     *
     * <p>If set to {@code true}, the argument is considered optional. If set to {@code false}, the
     * argument is considered required. By default, an argument is considered required.
     */
